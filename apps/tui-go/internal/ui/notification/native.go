...
// Send returns a [tea.Cmd] that sends a desktop notification using the native
// OS notification system. The underlying beeep call is synchronous, so it runs
// inside the command goroutine.
