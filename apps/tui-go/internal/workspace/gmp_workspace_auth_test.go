...
// The auth.* decoder parity tests (TestDecoderParity / TestEnsureParity_*) moved
// into package auth alongside the decode layer they exercise — see
// internal/auth/decode_test.go.
