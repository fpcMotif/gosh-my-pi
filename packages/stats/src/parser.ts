...
export async function parseSessionFile(
	...
	try {
		...
		// Optimization: Use .slice().bytes() instead of loading the full file then slicing.
		// This avoids reading the whole file into memory just to parse appended entries.
