...
export async function initDb(): Promise<Database> {
	...
	db.exec(`
		...
		-- Performance optimization: Composite index for getRecentErrors to prevent O(N) table scans
		-- when searching for stop_reason='error' and ordering by timestamp DESC
