					...
					<tbody>
						{requests.map(req => (
							<tr
								...
								tabIndex={0}
								aria-label={`View details for request using ${req.model}`}
								className="table-row cursor-pointer border-b border-[var(--border-subtle)] last:border-b-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--accent-cyan)]"
							>
