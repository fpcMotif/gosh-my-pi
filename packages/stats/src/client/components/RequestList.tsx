					...
					<tbody>
						{requests.map(req => (
							<tr
								...
								className="table-row cursor-pointer border-b border-[var(--border-subtle)] last:border-b-0 focus-visible:ring-2 focus-visible:ring-[var(--accent-cyan)] focus-visible:outline-none"
							>
