					...
					<tbody>
						{requests.map(req => (
							<tr
								...
								className="table-row cursor-pointer border-b border-[var(--border-subtle)] last:border-b-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:bg-[var(--bg-hover)] focus-visible:ring-inset focus-visible:ring-[var(--accent-cyan)]"
							>
