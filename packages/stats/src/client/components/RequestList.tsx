					...
					<tbody>
						{requests.map(req => (
							<tr
								...
								tabIndex={0}
								role="button"
								aria-label={`View request details for ${req.model}`}
								className="table-row cursor-pointer border-b border-[var(--border-subtle)] last:border-b-0 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--accent-cyan)] focus:outline-none"
							>
