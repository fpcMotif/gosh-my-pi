						...
						{requests.map(req => (
							...
							>
								...
								<td className="py-3 px-4 text-center">
									{req.errorMessage ? (
										<span title="Error" aria-label="Error" role="img">
											<XCircle size={16} aria-hidden="true" className="text-[var(--accent-red)] mx-auto" />
										</span>
									) : (
										<span title="Success" aria-label="Success" role="img">
											<CheckCircle2
												size={16}
												aria-hidden="true"
