...
// ⚡ Bolt: Extract inline default array to prevent breaking memoization.
...
const TrendChart = memo(function TrendChart({
	...
	// ⚡ Bolt: Memoize chartData to prevent re-renders on every parent state change
...
const PerformanceChart = memo(function PerformanceChart({
	...
	// ⚡ Bolt: Memoize options to prevent re-renders on every parent state change
