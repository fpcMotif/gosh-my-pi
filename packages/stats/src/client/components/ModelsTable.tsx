...
const EMPTY_TREND_DATA: Array<{ timestamp: number; avgTokensPerSecond: number | null }> = [];
...
// ⚡ Bolt: Memoize chart components to prevent expensive React-Chart.js re-renders on row expansion
