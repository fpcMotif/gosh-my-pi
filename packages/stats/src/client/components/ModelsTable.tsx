...
// ⚡ Bolt: Added React.memo and useMemo to prevent severe Chart.js canvas re-renders
// during parent state changes (like row expansion). Reduces re-renders by ~50%
...
const TrendChart = memo(function TrendChart({
	...
	// ⚡ Bolt: Memoize chartData to maintain stable reference
...
// ⚡ Bolt: Added React.memo to prevent expensive re-renders when parent state changes.
const PerformanceChart = memo(function PerformanceChart({
	...
	// ⚡ Bolt: Memoize options to maintain stable reference
