...
// ⚡ Bolt: Memoize chartData and component to prevent re-rendering on parent state changes
...
// ⚡ Bolt: Memoize chartData, options, and component to prevent re-rendering on parent state changes
