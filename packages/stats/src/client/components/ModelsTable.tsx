...
// ⚡ Bolt: Extract inline default array to module-level constant to prevent breaking memoization
...
// ⚡ Bolt: Memoize TrendChart and its chartData to prevent unnecessary re-renders in list rows
...
// ⚡ Bolt: Memoize PerformanceChart and its config objects to prevent unnecessary re-renders in list rows
