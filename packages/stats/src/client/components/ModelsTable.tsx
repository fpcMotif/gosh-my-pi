...
const TrendChart = memo(function TrendChart({
	...
	// ⚡ Bolt: Memoize chartData to prevent re-rendering ChartJS on parent state changes
...
const PerformanceChart = memo(function PerformanceChart({
	...
	// ⚡ Bolt: Memoize options to prevent re-rendering ChartJS on parent state changes
