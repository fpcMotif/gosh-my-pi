...
const TrendChart = memo(function TrendChart({
	...
	// ⚡ Bolt: Memoize chartData to enforce stable object references to prevent unnecessary re-renders in react-chartjs-2
...
const PerformanceChart = memo(function PerformanceChart({
	...
	// ⚡ Bolt: Memoize options to enforce stable object references to prevent unnecessary re-renders in react-chartjs-2
