...
// ⚡ Bolt: Extract default array to prevent breaking memoization
const EMPTY_TREND_DATA: ModelPerformanceSeries["data"] = [];
...
// ⚡ Bolt: Memoize chart components and their data objects to prevent re-renders when parent rows expand/collapse
...
// ⚡ Bolt: Memoize chart components and their data/options objects to prevent re-renders
