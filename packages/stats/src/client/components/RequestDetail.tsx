...
export function RequestDetail({ id, onClose }: RequestDetailProps) {
	...
	return (
		...
		>
			{details ? (
				<div className="w-[600px] max-w-full bg-[var(--bg-page)] h-full overflow-y-auto border-l border-[var(--border-subtle)] animate-slide-up">
					{/* Header */}
					<div className="sticky top-0 bg-[var(--bg-page)]/95 backdrop-blur border-b border-[var(--border-subtle)] px-6 py-4 flex justify-between items-center z-10">
						<div className="flex items-center gap-3">
							<div className="size-8 rounded-[var(--radius-sm)] bg-gradient-to-br from-[var(--accent-pink)]/20 to-[var(--accent-cyan)]/20 flex items-center justify-center">
				...
				<div className="w-[600px] max-w-full bg-[var(--bg-page)] h-full flex justify-center items-center border-l border-[var(--border-subtle)]">
