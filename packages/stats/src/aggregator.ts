...
// ⚡ Bolt: Cache active sync promise to coalesce concurrent requests
// Prevents redundant file reads and SQLite database locks when the frontend
// concurrently requests /stats, /recent, and /errors during load.
