...
export async function syncAllSessions(): Promise<{ processed: number; files: number }> {
	// ⚡ Bolt: Apply promise coalescing to deduplicate concurrent sync operations.
	// The frontend dashboard concurrently requests /stats, /recent, and /errors on load,
	// causing 3 parallel executions of this file I/O heavy operation.
