 ...
 * the entire ~290 lines of streaming-edit guard logic now live behind one
 * field on the session. Disabling the guard is a one-line change.
 */
export class StreamingEditGuard {
	...
	preCache(event: AgentEvent): void {
		...
		if (shouldCheckAutoGenerated) {
			...
			this.#abortForAutoGeneratedPath(
