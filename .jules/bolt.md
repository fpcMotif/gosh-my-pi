...
## 2026-08-28 - SQLite Partial Index for Filtered Sorts
...
**Action:** Create partial indexes for frequent queries that combine a WHERE filter and an ORDER BY clause.
