...
## 2024-07-20 - React-Chartjs-2 Re-rendering
...
**Action:** Wrap chart components in `React.memo` and their data/options in `useMemo` to enforce stable object references.
