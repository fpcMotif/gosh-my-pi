...
## 2024-05-19 - Partial Indexes for Error Queries
**Learning:** When querying recent errors by filtering `stop_reason` and sorting by `timestamp DESC`, adding a partial index covering both significantly speeds up execution compared to standard indices by eliminating full index scans.
**Action:** Add partial covering indices for filtered and sorted queries.
