...
## 2024-07-18 - React-chartjs-2 Performance in Lists
**Learning:** Creating inline chartData or options objects inside list/table rows causes severe performance degradation due to React re-rendering the chart on every parent state change.
