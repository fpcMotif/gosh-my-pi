...
## 2026-07-15 - SQLite Composite Indexing
**Learning:** In bun:sqlite, database operations are synchronous. Missing indices on commonly queried fields (like combining filtering and sorting) cause full table scans that block the Node.js event loop and degrade application responsiveness.
