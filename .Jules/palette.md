...
## 2024-07-28 - Add Backdrop Click Dismissal to Native Dialog

**Learning:** Native `<dialog>` elements do not automatically close when clicking the backdrop, which breaks user expectations for modal dismissal.
