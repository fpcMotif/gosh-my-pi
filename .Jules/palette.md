...
## 2026-08-30 - ARIA Tab Links
**Learning:** Tab roles require explicit bidirectional linking between tabs and panels to be accessible for screen readers.
**Action:** Always add id and aria-controls to tab buttons, and role="tabpanel", id, and aria-labelledby to the corresponding container.
