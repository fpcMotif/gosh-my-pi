...
## 2025-01-24 - [Native Dialog Backdrop Dismissal]
**Learning:** Native HTML `<dialog>` elements do not automatically close when clicking their backdrop (unlike clicking the Escape key). Users expect modals to dismiss when clicking outside the content area.
