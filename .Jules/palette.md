...
## 2025-02-20 - [Add Backdrop Click Dismissal to Modals]
**Learning:** Native HTML `<dialog>` elements do not automatically close when clicking the backdrop. This creates a frustrating UX trap where users expect clicking outside the modal content to dismiss it, but it does nothing.
