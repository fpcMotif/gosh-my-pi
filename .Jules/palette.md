...
## 2025-02-12 - [Backdrop Click Dismissal for Native Dialogs]
**Learning:** Native HTML `<dialog>` elements do not automatically close when clicking their backdrop.
**Action:** Add an `onClick` handler checking `e.target === dialogRef.current` to enable backdrop dismissals.
