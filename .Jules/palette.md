...
## 2024-10-25 - Native Dialog Backdrop Dismissal
**Learning:** Native HTML `<dialog>` elements do not automatically close when clicking the backdrop. This creates a frustrating experience where users expect to click outside the modal to close it, but nothing happens.
