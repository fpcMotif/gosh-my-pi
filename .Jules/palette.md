...
## 2024-05-20 - [Native Dialog Backdrop Dismissal]
**Learning:** Native HTML `<dialog>` elements do not automatically close when clicking the backdrop, which is a common UX expectation for modals.
