...
## 2024-05-20 - Add Backdrop Click Dismissal to Dialogs
**Learning:** Native HTML `<dialog>` elements do not automatically close when clicking the backdrop, which violates common user expectations for modal behaviors.
