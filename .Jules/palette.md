...
## 2026-08-02 - Dismiss Native Dialog on Backdrop Click
**Learning:** Native HTML `<dialog>` elements do not automatically close when clicking the backdrop, which is a common pattern users expect.
