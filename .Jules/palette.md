...
**Learning:** Native HTML `<dialog>` elements do not automatically close when clicking the backdrop, which can frustrate users expecting standard modal behavior.
